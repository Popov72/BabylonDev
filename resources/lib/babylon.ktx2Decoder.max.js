(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("babylonjs-ktx2-decoder", [], factory);
	else if(typeof exports === 'object')
		exports["babylonjs-ktx2-decoder"] = factory();
	else
...
/*!*******************************************************************************!*\
  !*** D:/alexis/TombRaider/Popov72/Babylon.js/node_modules/tslib/tslib.es6.js ***!
  \*******************************************************************************/
...
var LiteTranscoder = /** @class */ (function (_super) {
    ...
    LiteTranscoder.prototype._loadModule = function () {
        ...
        this._modulePromise = new Promise(function (resolve) {
            _wasmMemoryManager__WEBPACK_IMPORTED_MODULE_2__["WASMMemoryManager"].LoadWASM(_this._modulePath).then(function (wasmBinary) {
...
var LiteTranscoder_UASTC_BC7 = /** @class */ (function (_super) {
    ...
    LiteTranscoder_UASTC_BC7.CanTranscode = function (src, dst) {
        return src === _transcoder__WEBPACK_IMPORTED_MODULE_1__["sourceTextureFormat"].UASTC4x4 && dst === _transcoder__WEBPACK_IMPORTED_MODULE_1__["transcodeTarget"].BC7_M5_RGBA;
    };
...
var MSCTranscoder = /** @class */ (function (_super) {
    ...
    MSCTranscoder.prototype._getMSCBasisTranscoder = function () {
        ...
        this._mscBasisTranscoderPromise = new Promise(function (resolve) {
            ...
            _wasmMemoryManager__WEBPACK_IMPORTED_MODULE_2__["WASMMemoryManager"].LoadWASM(MSCTranscoder.WasmModuleURL).then(function (wasmBinary) {
    ...
    MSCTranscoder.prototype.transcode = function (src, dst, level, width, height, uncompressedByteLength, ktx2Reader, imageDesc, encodedData) {
        ...
        return this._getMSCBasisTranscoder().then(function () {
            ...
            var texFormat = src === _transcoder__WEBPACK_IMPORTED_MODULE_1__["sourceTextureFormat"].UASTC4x4 ? TextureFormat.UASTC4x4 : TextureFormat.ETC1S;
            var imageInfo = new ImageInfo(texFormat, width, height, level);
            var targetFormat = TranscodeTarget[_transcoder__WEBPACK_IMPORTED_MODULE_1__["transcodeTarget"][dst]]; // works because the labels of the sourceTextureFormat enum are the same than the property names used in TranscodeTarget!
...
/*!******************!*\
  !*** ./index.ts ***!
  \******************/
/*! exports provided: KTX2Decoder, supercompressionScheme, KTX2FileReader, sourceTextureFormat, transcodeTarget, Transcoder, TranscoderManager, WASMMemoryManager, DataReader, LiteTranscoder, LiteTranscoder_UASTC_ASTC, LiteTranscoder_UASTC_BC7, MSCTranscoder */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _Misc_index__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./Misc/index */ "./Misc/index.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "DataReader", function() { return _Misc_index__WEBPACK_IMPORTED_MODULE_5__["DataReader"]; });

/* harmony import */ var _Transcoders_index__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./Transcoders/index */ "./Transcoders/index.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "LiteTranscoder", function() { return _Transcoders_index__WEBPACK_IMPORTED_MODULE_6__["LiteTranscoder"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "LiteTranscoder_UASTC_ASTC", function() { return _Transcoders_index__WEBPACK_IMPORTED_MODULE_6__["LiteTranscoder_UASTC_ASTC"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "LiteTranscoder_UASTC_BC7", function() { return _Transcoders_index__WEBPACK_IMPORTED_MODULE_6__["LiteTranscoder_UASTC_BC7"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "MSCTranscoder", function() { return _Transcoders_index__WEBPACK_IMPORTED_MODULE_6__["MSCTranscoder"]; });
...
var KTX2Decoder = /** @class */ (function () {
    ...
    KTX2Decoder.prototype.decode = function (data, caps) {
        ...
        else if (caps.bptc && srcTexFormat === _transcoder__WEBPACK_IMPORTED_MODULE_5__["sourceTextureFormat"].UASTC4x4) {
            targetFormat = _transcoder__WEBPACK_IMPORTED_MODULE_5__["transcodeTarget"].BC7_M5_RGBA;
